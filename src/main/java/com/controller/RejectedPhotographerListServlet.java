...
public class RejectedPhotographerListServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		List<PhotographerBean> listOfPhotographer = new PhotographerDAO().rejectedList();
		if (listOfPhotographer != null) {
			request.setAttribute("title", "reject");
