			...
			<div class="cl4">
				<div class="form" style="width: 100%;box-sizing: border-box;">
				  ...
				  <div style="box-sizing: border-box;overflow: hidden;">
			    	<form action="PhotographerLoginServlet" method="post" class="loginform">
			    		<%
			    		String str="";
			    		str = (String)request.getAttribute("photographerEmailId");
			    		%>
						<label class="emailorusername">Email or Username</label>
						<input type="text" class="emailbox" name="txtPhotographerEmailId" value="${txtPhotographerEmailId}">
						<label class="password">Password</label>
						<div class="passwordbox">
							<input type="password" class="passbox" name="pwdPassword">
   							<div><img src="imgs/eye.svg"/></div>
	    				</div>
	    				<div class="tright" style="margin-bottom:5px;position:relative;top:-7px;"><a href="forgetPassword.jsp" class="link forgotpasswordq">Forget Password?</a></div> 
