...
<body>
	...
	<div style="margin-top: -850px; margin-left: 250px;">
		...
		<div class="col-lg-6">
			<div class="container">
				<form action="CountryInsertServlet" method="post">
					<br />
					<div class="row">
						<label class="col-sm-2"> <font size="+1">Country Name
								:</font>
						</label>
						...
						<div class="col-lg-6">
							<input type="text" class="form-control" name="txtCountryName"
								...
								value="${txtCountryName}" /> <font color="red">${countryName}
							</font>
						</div>
					</div>
					<br />
					<div class="row">
						<label class="col-sm-2"> <font size="+1">Country Code : </font>
						</label>
						<div class="col-lg-6">
							<input type="text" class="form-control" name="txtCountryCode"
								placeholder="91" maxlength="5" oninput="space(this);onlydigit(this);"
								value="${txtCountryCode}" /> <font color="red">${countryCode}
							</font>
						</div>
					</div>
